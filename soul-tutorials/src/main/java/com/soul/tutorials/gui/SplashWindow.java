package com.soul.tutorials.gui;
...
public class SplashWindow extends JWindow {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4393345975156530660L;
...
//					SwingUtilities.invokeLater(closerRunner);
	...
	public static void main(String[] args){
		...
		SplashWindow splash = new SplashWindow(System.getProperty("user.dir")+"/image/Juggler0.gif", frame, 600);
		frame.pack();
