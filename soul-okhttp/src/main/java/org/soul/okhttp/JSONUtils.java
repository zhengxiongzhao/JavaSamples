...
public class JSONUtils {
    ...
    public static JSONObject toJSONObject(String jsonData, JSONObject defaultValue){
    	if (StringUtils.isEmpty(jsonData)) {
            return defaultValue;
        }
    ...
    public static JSONArray toJSONArray(String jsonData, JSONArray defaultValue){
    	if (StringUtils.isEmpty(jsonData)) {
            return defaultValue;
        }
     ...
     * @return <ul>
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if index le 0 or jsonArray is empty, return defaultValue</li>
     *         <li>if {@link JSONArray#getString(index)} exception, return defaultValue</li>
     *         <li>return {@link JSONArray#getString(String)}</li>
     *         </ul>
     */
